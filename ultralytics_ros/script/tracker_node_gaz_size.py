...
class TrackerNode:
    def __init__(self):
        ...
        #if len(image_topics) != 4:
            #rospy.logfatal("Please provide exactly 4 image topics.")
            #rospy.signal_shutdown("Incorrect number of image topics provided.")
    ...
    def image_callback(self, msg, topic):
        ...
        self.image_dict[self.image_topic_to_position[topic]] = resized_image
